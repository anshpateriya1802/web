...
export default function RoomSidebar({ roomId, currentUserId, currentUserEmail }: RoomSidebarProps) {
  const { participants, activeOverlayUserId, setOverlayUser, isWhiteboardOpen, toggleWhiteboard, isProblemOpen, toggleProblem } = useRoomStore()
  const [copied, setCopied] = useState(false)

  // Filter out duplicates and self for rendering
        ...
        <ul className="space-y-4">
          <li className="flex flex-col space-y-2">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-sm font-medium">{currentUserEmail} (You)</span>
            </div>
          </li>
